...
\begin{document}
\title{Eric Clapton - Autumn Leaves Chords/Tabs}
\author{Wills Liou}
Inspired by Gabriella Quevedo

Tuning: C G D G A\# D (from low to high + capo 4th fret

\begin{figure}
\subfloat[G major]{
\begin{chord}
% string (1 highest); fret #; finger
  \single 5 2 1 % pinky on 4th string 3rd fret
  \single 6 3 2 % ringfinger on 5th string 3rd fret
  \single 2 3 3 % index on 3rd string 2nd fret
   \single 1 3 4 % index on 3rd string 2nd fret
